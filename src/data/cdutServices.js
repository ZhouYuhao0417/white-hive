...
export const cdutCampus = {
  ...
  name: '成都理工大学',
  nameEn: 'CDUT',
  tagline: '本校同学, 线下见面, 自行协商。',
  desc: '专门给成都理工大学在校同学做的小额线下服务撮合。跑腿、代拍、代取都走 WhiteHive 站内匹配, 金额和见面方式由买卖双方自行协商, 平台不介入资金。',
...
export const cdutTrustPoints = [
  ...
  },
  {
    icon: 'mail',
    title: '站内沟通留痕',
    desc: '校园专区不走平台托管, 买卖双方自行协商金额和支付方式; 所有沟通都留在站内, 方便出问题时复盘。',
    color: '#A5B4FC',
  },
  {
    icon: 'route',
