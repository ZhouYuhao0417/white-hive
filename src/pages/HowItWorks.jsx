...
function Timeline() {
  return (
    <div className="relative">
      {/* vertical line */}
      <div className="absolute left-[26px] top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-white/15 to-transparent" />
      <ol className="space-y-6">
        {steps.map((s, i) => (
          ...
          >
            <div className="absolute left-0 top-0 h-[52px] w-[52px] rounded-2xl border border-brand-300/30 bg-brand-300/[0.08] flex items-center justify-center">
              <span className="font-mono text-brand-200">{s.k}</span>
            </div>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {current.items.map((t, i) => (
            <li
              key={t}
              className="flex items-start gap-3 rounded-xl bg-white/[0.02] border border-white/8 px-4 py-3"
            >
              <span className="mono-label mt-[3px] text-white/45">
                0{i + 1}
              </span>
          ...
          <div className="mt-12 card p-8 md:p-10">
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                >
                  <div className="mono-label text-white/45">{f.label}</div>
                  <div className="mt-2 text-sm text-white/85">{f.value}</div>
                </div>
              ))}
            </div>
