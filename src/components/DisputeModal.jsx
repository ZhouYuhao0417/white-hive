      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[90] w-[92%] max-w-[560px] max-h-[88vh] overflow-hidden rounded-2xl bg-ink-900 border border-white/10 shadow-2xl shadow-black/50 flex flex-col"
          >
            <div className="flex items-center justify-between px-6 h-14 border-b border-white/5 shrink-0">
              <div className="flex items-center gap-2.5">
                <span className="h-8 w-8 rounded-lg bg-[#FBBF77]/12 border border-[#FBBF77]/30 text-[#FBBF77] grid place-items-center">
                  <Icon name="shield" size={15} />
                </span>
                <div>
                  <div className="text-sm font-semibold text-white">申请平台介入</div>
                  <div className="text-[11px] text-white/45">订单 {orderId}</div>
                </div>
              </div>
              <button
                onClick={onClose}
                className="h-8 w-8 grid place-items-center rounded-lg text-white/55 hover:text-white hover:bg-white/5 transition-colors"
                aria-label="close"
              >
            ...
            <form onSubmit={submit} className="flex-1 overflow-y-auto px-6 py-5">
                  ...
                  {reasons.map((r) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="mt-1 text-[11px] text-white/45 pl-5">{r.hint}</div>
                      </button>
                    )
                  })}
                </div>
              ...
              <div className="mt-5">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/[0.03] border border-white/10 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-[#7FD3FF]/55 focus:bg-white/[0.05] transition-colors resize-none leading-relaxed"
                />
              ...
              <div className="mt-5 rounded-xl border border-white/8 bg-black/20 px-4 py-3 text-[11px] sm:text-xs text-white/55 leading-relaxed">
